...
public class QueryUserByIdResp implements T_Base {
    ...
    static {
        T_Container.JCE_STRUCT.put(QueryUserByIdResp._t_className, new T_JceStruct<Read, Write,QueryUserByIdResp>(Read.class, Write.class, QueryUserByIdResp.class,QueryUserByIdResp._t_className));
    }
