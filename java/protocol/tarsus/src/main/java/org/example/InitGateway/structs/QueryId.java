...
public class QueryId implements T_Base {
    ...
    static {
        T_Container.JCE_STRUCT.put(QueryId._t_className, new T_JceStruct<Read, Write, QueryId>(Read.class, Write.class, QueryId.class, QueryId._t_className));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Write ws = write.Serialize(queryId);
